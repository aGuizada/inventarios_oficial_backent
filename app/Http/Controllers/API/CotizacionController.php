...
class CotizacionController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return ApiError::serverError($e, 'Error al cargar las cotizaciones', 'CotizacionController@index');
        }
    }
        ...
        try {
            ...
            if (! $clienteId && $request->cliente_nombre) {
                try {
                    ...
                    return ApiError::serverError($e, 'Error al crear el cliente', 'CotizacionController@store cliente');
                }
            }
            ...
            $cotizacionData = $request->except(['detalles', 'cliente_nombre', 'total', 'user_id']);
            $cotizacionData['cliente_id'] = $clienteId;

            // Asegurar que los campos numéricos sean números
            $cotizacionData['user_id'] = $request->user()->id;
            ...
            return ApiError::serverError($e, 'Error al crear la cotización', 'CotizacionController@store');
        }
    }
        ...
        try {
            ...
            if (! $clienteId && $request->cliente_nombre) {
                try {
                    ...
                    return ApiError::serverError($e, 'Error al crear el cliente', 'CotizacionController@update cliente');
                }
            }
